...
const Blog = () => {
  ...
  return (
    <section id="blog" className="py-20 bg-primary-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Latest <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-blue-500">Insights</span>
          </h2>
        ...
        <div className="text-center mt-12">
          ...
          >
            <Link to="/blog">
              <Button
                variant="outline"
                className="inline-flex items-center justify-center px-6 py-3 border border-purple-600 text-purple-600 hover:bg-purple-600 hover:text-white transition duration-300 rounded-lg"
              >
